...
export default function TravelBuddyModal({ isOpen, onClose, tripId, tripTitle, currentUser }: TravelBuddyModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="bg-white dark:bg-slate-900 border-4 border-black dark:border-white max-w-md w-full p-6 rounded-2xl shadow-[8px_8px_0_#000] dark:shadow-[8px_8px_0_#fff]">
        {/* Header */}
